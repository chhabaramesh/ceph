...
OPTION(bluestore_num_kv_sync_threads, OPT_U32, 1)
...
OPTION(bluestore_debug_omit_block_device_write, OPT_U32, 0)
OPTION(bluestore_inject_wal_apply_delay, OPT_FLOAT, 0)
OPTION(bluestore_shard_finishers, OPT_BOOL, false)
OPTION(bluestore_skip_db_write_for_dbg, OPT_U32, 0)
OPTION(bluestore_skip_ZS_fm_for_dbg, OPT_U32, 0)
OPTION(bluestore_skip_ZS_btree_for_dbg, OPT_U32, 0)
OPTION(bluestore_skip_ZS_log_for_dbg, OPT_U32, 0)
OPTION(bluestore_skip_wal_for_dbg, OPT_U32, 0)
OPTION(bluestore_skip_1_for_dbg, OPT_U32, 0)
OPTION(bluestore_skip_2_for_dbg, OPT_U32, 0)
